...
import com.bloggingapp.demo.config.AppConstant;
...
public class PostController {
	...
	public ResponseEntity<PostResponce> getAllPostById (
		 ...
		 PostResponce allPost = postService.getAllPost(pageNumber, pageSize, sortBy,sortDir);
	...
	// get all post
	 ...
	 // searchpost 
		...
		public ResponseEntity<List<Post>> searchPostByTitle (@PathVariable String keyword ){
			
			List<Post> searchResult = postService.searchPost(keyword);
